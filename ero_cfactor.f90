...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real :: max     !              |   made real per above comment by unknown, KDW 12/20/21
    
      j = ihru

      !! HRU sediment calculations
      cover = pl_mass(j)%ab_gr_com%m + rsd1(j)%tot_com%m ! moved out from if loop b/c needed in else statement, KDW 12/20/21
