...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real :: minpacon     !mg P/L        |initial organic P concentration in reach - KDW
      real :: minpscon     !mg P/L        |initial organic P concentration in reach - KDW
...
!! concentrations
         ...
         orgpin = 1000. * ob(icmd)%hd(1)%orgp  / wtrin ! - KDW
         minpain = 1000. * ob(icmd)%hd(1)%minpa  / wtrin ! - KDW
         minpsin = 1000. * ob(icmd)%hd(1)%minps  / wtrin ! - KDW
...
!! phosphorus calculations
        ...
        ch(jrch)%minpa = 0.  ! - KDW
        ch(jrch)%minpa = minpacon ! - KDW
        if (ch(jrch)%minpa < 1.e-6) ch(jrch)%minpa = 0. ! - KDW

        ch(jrch)%minps = 0. ! - KDW
        ch(jrch)%minps = minpscon ! - KDW
