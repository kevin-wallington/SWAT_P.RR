...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      use hru_module, only : hru, canstor, blai_com, ihru, precipday, precip_eff !KDW added precip_eff on 10/08
      use plant_module
      ...
      !real :: precip_eff         !mm            |daily effective precip for runoff calculations = precipday + ls_overq + snomlt - canstor ! commented out by KDW, comes from hru_module. 10/08
