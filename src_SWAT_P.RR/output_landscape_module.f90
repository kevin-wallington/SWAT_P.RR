      ...
      type output_losses
        ...
        real :: latsolp = 0.               !kg P/ha        | amt of soluble P in lat flow in HRU for the day - KDW
        real :: tilesolp = 0.              !kg P/ha        | soluble phos in tile flow - KDW
      ...
      type output_plantweather
        ...
        real :: percp = 0.                 !kg N/ha       |Soluble phos leached from soil profile - KDW
      ...
      type output_losses_header
        ...
        character (len=12)  :: latno3   =  "      latno3"            
        ...
        character (len=12)  :: latsolp  =  "     latsolp" ! - KDW
        character (len=12)  :: tilesolp  =  "    tilesolp" ! - KDW
      ...
      type output_plantweather_header
        ...
        character (len=12) :: percp     =  "       percp" ! - KDW
      ...
      type output_plantweather_header_units
        ...
        character (len=12) :: percp     =  "        kgha" ! - KDW
      ...
      function hruout_losses_add (hru1, hru2) result (hru3)
        ...
        hru3%latsolp = hru1%latsolp + hru2%latsolp !  - KDW
        hru3%tilesolp = hru1%tilesolp + hru2%tilesolp ! - KDW
      ...
      function hruout_plantweather_add (hru1, hru2) result (hru3)
        ...
        hru3%pplnt = hru1%pplnt + hru2%pplnt ! - KDW
        hru3%percp = hru1%percp + hru2%percp ! - KDW
      ...
      function hruout_losses_div (hru1,const) result (hru2)
        ...
        hru2%latsolp = hru1%latsolp / const !  - KDW
        hru2%tilesolp = hru1%tilesolp  / const ! - KDW
      ...
      function hruout_plantweather_div (hru1,const) result (hru2)
        ...
        hru2%percp = hru1%percp / const ! - KDW
        hru2%tmx = hru1%tmx
        hru2%tmn = hru1%tmn
