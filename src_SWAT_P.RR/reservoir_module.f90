      ...
      type res_header
          ...
          character (len=10) :: orgp  =   "    orgp"        !! kg P         |organic P - KDW
          character (len=10) :: minpa  =   "    minpa"        !! kg P         |active mineral P - KDW
          character (len=10) :: minps  =   "    minps"        !! kg P         |stable mineral P - KDW
      ...
      type res_header1
       ...
       type reservoir_hdr
        ...
        character (len=10) :: orgp_loss  = " orgp_loss"             !kg     |organic phosphorus loss - KDW
        character (len=10) :: minpa_loss  = "minpa_loss"             !kg     |active mineral phosphorus loss - KDW
        character (len=10) :: minps_loss  = "minps_loss"             !kg     |stable mineral attached phosphorus loss - KDW
      ...
      type res_headerbsn
          ...
          character (len=12) :: orgp  = "        orgp"        !! kg P         |organic P -KDW
          character (len=12) :: minpa  = "       minpa"        !! kg P         |active mineral P - KDW
          character (len=12) :: minps  = "       minps"        !! kg P         |stable mineral P- KDW
       ...
       !! is this correct for res_out ??? also uses hy_output ??? gsm 9/2018
          ...
          character (len=10) :: orgp  = "    kg P"        !! kg P         |organic P- KDW
          character (len=10) :: minpa  = "    kg P"        !! kg P         |active mineral P - KDW 
          character (len=10) :: minps  = "    kg P"        !! kg P         |stable mineral P - KDW
       ...
       !! is this correct for Units res_out ??? also uses hy_output ??? gsm 9/2018
          ...
          character (len=10) :: orgp  = "      kg_P"        !! kg P         |organic P - KDW
          character (len=10) :: minpa  = "      kg_P"        !! kg P         |active mineral  - KDW
          character (len=10) :: minps  = "      kg_P"        !! kg P         |stable mineral P - KDW
       ...
       type res_header_unit2
        ...
        character (len=10) :: orgp_loss =    "        kg"        !kg     |organic phosphorus loss  - KDW
        character (len=10) :: minpa_loss =    "        kg"        !kg     |active mineral phosphorus loss  - KDW
        character (len=10) :: minps_loss =    "        kg"        !kg     |stable mineral phosphorus loss - KDW
...
type res_header_unitbsn
       !! is this correct for Units res_out ??? also uses hy_output ??? gsm 9/2018
          ...
          character (len=12) :: orgp  = "        kg_P"        !! kg P         |organic P - KDW
          character (len=12) :: minpa  = "        kg_P"        !! kg P         |active mineral P - KDW
          character (len=12) :: minps  = "        kg_P"        !! kg P         |stable mineral P - kDW
