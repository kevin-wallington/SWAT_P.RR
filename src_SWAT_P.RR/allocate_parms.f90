...
!! New P leaching and lateral flow equations - KDW
      allocate (latsolp(mhru))
      allocate (tilesolp(mhru))
      allocate (latorgp(mhru))
      allocate (tileorgp(mhru))
      allocate (latminpa(mhru))
      allocate (tileminpa(mhru))
      allocate (latminps(mhru))
      allocate (tileminps(mhru))
      allocate (latorgn(mhru))
      allocate (tileorgn(mhru))
      allocate (latsan(mhru))
      allocate (latsil(mhru))
      allocate (latcla(mhru))
      allocate (latsag(mhru))
      allocate (latlag(mhru))
      allocate (latsed(mhru))
      allocate (tilesed(mhru))
      allocate (tilesan(mhru))
      allocate (tilesil(mhru))
      allocate (tilecla(mhru))
      allocate (tilesag(mhru))
      allocate (tilelag(mhru))
!! New P leaching and lateral flow equations - KDW

	allocate (stmaxd(mhru))
      allocate (itill(mhru))
      allocate (surfq(mhru))
      allocate (surfq_pervious(mhru)) ! KDW 11/22/21
