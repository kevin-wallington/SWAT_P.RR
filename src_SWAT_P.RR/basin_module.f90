      ...
      type basin_control_codes
        ...
        integer :: wq = 0        !! stream water quality code
                                 !!   0 do not model
                                 !!   1 model (QUAL2E)
                                 !!   2 model with SWAT+P updates from KDW, 08/13
        ...
        integer :: sed_ch = 0    !! Instream sediment model
                                 ...
                                 !!   1 = Brownlie model
                                 !!   2 = Yang model
                                 !! For old sediment code (i.e. not sdchannel, deg = 0), ) is simplified Bagnold, 1-4 are physics-based approaches (Bagnold, Kodatie, Molinas, Yang) - KDW - 08/13
        ...
        integer :: sol_p_model=0 !! 1 = new soil P model
                                 !! 2 = KDW soil P model with Langmuir isotherm, soluble P leaching, and tile P transport - KDW 08/13
      ...
      type basin_parms
        ...
        real :: open_var3 = 0.      !! curve number retention parameter adjustment for low gradient
                                    !!  non-draining soils
      !! Added by KDW
        real :: srpm2 = 0.002        !! adsorption sites per kg (of clay) - KDW 04/14/22
        real :: adskeq = 0.01       !! phosphorus adsorption equilibrium constant - KDW
        real :: sbdk = 0.01        !! exponential rate of sediment embeddment in bed - KDW
      !! Added by KDW
