      ...
      type channel_init_datafiles
        ...
        character(len=16) :: bed = ""                 !points to initial streambed input file, KDW 11/04/21
      ...
      type channel_sed_data
        ...
        real :: kod_a  = 0.     !               | Kodatie regression coefficient a - KDW 06/24
        real :: kod_b  = 0.     !               | Kodatie regression coefficient b - KDW 06/24
        real :: kod_c  = 0.     !               | Kodatie regression coefficient c - KDW 06/24
        real :: kod_d  = 0.     !               | Kodatie regression coefficient d - KDW 06/24
        real :: pdep_alt = 0.   !               | alters exponent in percent deposition calculation, KDW 10/25/21
      ...
      type channel_nut_data
        ...
        real :: rs2 = .005         ! (mg disP-P)/    |benthos source rate for dissolved phos ((m**2)*day)|in reach at 20 deg C
        !                                              or (mg disP-P)/((m**2)*hr)| - changed from .0005 by KDW
        ...
        real :: w12 = .0005         ! (mg P)/ day     |bioturbation rate constant - KDW
        real :: cbod_half = 40.     ! (mg cbod)/L     |reference cbod level for bioturbation
        real :: dox_half = 3.      ! mg dox/L        |dissolved oxygen level where bioturbation is half of its max
        real :: srpm2 = 0.002         ! sites for P (kg P) per Mg clay sediment - KDW
        real :: adskeq = 0.01         ! equilibrium constant for P adsorption - KDW 07/27
