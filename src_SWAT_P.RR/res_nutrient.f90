subroutine res_nutrient (jres, inut, iob)
  ...
  integer, intent (in) :: inut            !none          |counter
  ...
  conc_p = 1000. * (wbody%orgp + wbody%minpa + wbody%minps + wbody%solp) / wbody%flo
  ...
  wbody%orgp = wbody%orgp * (1. - phosk)
  wbody%minpa = wbody%minpa * (1. - phosk)
  wbody%minps = wbody%minps * (1. - phosk)
  ...
  chlaco = 0.
  wbody%chla = 0.
  tpco = 1.e+6 * (wbody%solp + wbody%orgp + wbody%minpa + wbody%minps) / (wbody%flo + ht2%flo)
  if (tpco > 1.e-4) then
  ...
  wbody%orgp = amax1 (wbody%orgp, 0.0)
  wbody%minpa = amax1 (wbody%minpa, 0.0)
  wbody%minps = amax1 (wbody%minps, 0.0)
  ...
  ht2%orgp = wbody%orgp * ht2%flo / (wbody%flo + ht2%flo)
  ht2%minpa = wbody%minpa * ht2%flo / (wbody%flo + ht2%flo)
  ht2%minps = wbody%minps * ht2%flo / (wbody%flo + ht2%flo)
