    ...
    implicit none      
      ...
      type reservoir_init_data_char
        ...
        character (len=25) :: bed                  !points to initial streambed input file, KDW 11/04/21
      ...
      type reservoir_init_data
        ...
        integer :: bed = 1                  !points to initial streambed input file, KDW 11/04/21
      ...
      type reservoir_sed_data
        ...
        real :: trapeff             !fraction   |maximum fraction of sediment which can be "immediately trapped" upon inflow - KDW04/28
      ...
      type reservoir_nut_data
        ...
        integer :: ch_params = 0       !none       |points to channel to use for nutrients transformation parameters
