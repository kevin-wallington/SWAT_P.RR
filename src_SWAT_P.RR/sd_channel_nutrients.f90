      ...
      real :: totsedp               !              | - KDW
      real :: orgp_reduc            !              | - KDW
      real :: minpa_reduc           !              | - KDW
      real :: minps_reduc           !              | - KDW
      ...
      tp_conc = ht1%orgp + ht1%minpa + ht1%minps + ht1%solp ! - KDW
          ...
          if (sd_ch(ich)%overbank == "ob") then
            ...
            if (tp_conc > rte_nut(inut)%tp_min_conc .and. tp_conc > 1.e-6) then
              ...
              tp_reduc = tp_reduc * area_m2 * ht2%flo / 1000.          !kg/d = mg/L/m^2 * m2 * (kg / 1000000. mg) * flo(m3/d) 1000. L/m3
               ...
               totsedp = ht2%orgp + ht2%minpa + ht2%minps   ! - KDW
               !sedp_reduc = 0.90 * tp_reduc
               orgp_reduc = (ht2%orgp / totsedp) * 0.90 * tp_reduc ! - KDW
               minpa_reduc = (ht2%orgp / totsedp) * 0.90 * tp_reduc ! - KDW
               minps_reduc = (ht2%orgp / totsedp) * 0.90 * tp_reduc ! - KDW
               !ht2%sedp = ht2%sedp - sedp_reduc
               !ht2%sedp = amax1(0., ht2%sedp)
               ht2%orgp = ht2%orgp - orgp_reduc ! - KDW
               ht2%orgp = amax1(0., ht2%orgp) ! - KDW
               ht2%minpa = ht2%minpa - minpa_reduc ! - KDW
               ht2%minpa = amax1(0., ht2%minpa) ! - KDW
               ht2%minps = ht2%minps - minps_reduc ! - KDW
               ht2%minps = amax1(0., ht2%minps) ! - KDW
            end if
            !tp_conc = 1000. * (ht1%sedp + ht1%solp) / ht2%flo
            tp_conc = 1000. * (ht1%orgp + ht1%minpa + ht1%minps + ht1%solp) / ht2%flo ! - KDW
