...
!!    ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
      ...
      harveff1 = 1. - harveff
      !soil1(j)%hs(1) = harveff1 * pl_mass(j)%seed(ipl) + soil1(j)%hs(1) ! commented out by KDW 10/15/21
      soil1(j)%microb(1)  = harveff1 * pl_mass(j)%seed(ipl) + soil1(j)%microb(1) ! KDW 10/15/21
