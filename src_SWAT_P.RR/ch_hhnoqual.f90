...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real :: minpacon         !mg P/L        |initial active mineral P concentration in reach - KDW
      real :: minpain          !mg P/L        |acitve mineral P concentration in inflow - KDW
      real :: minpscon         !mg P/L        |initial stable mineral P concentration in reach - KDW
...
!! concentrations
         ...
         orgpin = 1000. * ob(icmd)%ts(1,ii)%orgp / wtrin
         minpain = 1000. * ob(icmd)%ts(1,ii)%minpa / wtrin ! - KDW
         minpsin = 1000. * ob(icmd)%ts(1,ii)%minps / wtrin ! - KDW
         ...
         if (minpain < 1.e-6) minpain = 0.0 ! - KDW
         if (minpsin < 1.e-6) minpsin = 0.0 ! - KDW
         ...
         orgpcon = (orgpin * wtrin + ch(jrch)%organicp * hrchwtr(ii))     & 
                                                               / wtrtot
         minpacon = (minpain * wtrin + ch(jrch)%minpa * hrchwtr(ii))     & 
                                                               / wtrtot ! - KDW
         minpscon = (minpsin * wtrin + ch(jrch)%minps * hrchwtr(ii))     & 
                                                               / wtrtot ! - KDW
         ...
         minpacon = (minpain * wtrin + hminpa(ii-1) * hrchwtr(ii)) / wtrtot ! - KDW
         minpscon = (minpsin * wtrin + hminps(ii-1) * hrchwtr(ii)) / wtrtot ! - KDW
...
!! phosphorus calculations
        ...
        hminpa(ii) = 0.! - KDW
        hminpa(ii) = minpacon ! - KDW
        if (hminpa(ii) < 0.) hminpa(ii) = 0.! - KDW

        hminps(ii) = 0.! - KDW!
        hminps(ii) = minpscon ! - KDW
        if (hminps(ii) < 0.) hminps(ii) = 0.! - KDW
...
!! end phosphorus calculations
        ...
        if (hminpa(ii) < 1.e-6) hminpa(ii) = 0.0 ! - KDW
        if (hminps(ii) < 1.e-6) hminps(ii) = 0.0 ! - KDW
...
!! set end of day concentrations
      ...
      ch(jrch)%minpa = hminpa(time%step) ! - KDW
      ch(jrch)%minps = hminps(time%step) ! - KDW
      ...
      if (ch(jrch)%minpa < 1.e-6) ch(jrch)%minpa = 0.0 ! - KDW
      if (ch(jrch)%minps < 1.e-6) ch(jrch)%minps = 0.0 ! - KDW
