...
!!    quality calculations
      ...
      if (ht3%flo > 0.) then
        ...
        bc4_m = wq_k2m (tday, rt_delt, -bc4_k, ch_stor(jrch)%orgp, ht3%orgp) ! - KDW
        rs5_k = 0.
        ...
        ht2%orgp = wq_semianalyt (tday, rt_delt, factm, factk, ch_stor(jrch)%orgp, ht3%orgp) ! - KDW
        if (ht2%orgp < 1.e-6) ht2%orgp = 0. ! - KDW
