...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      do l = 1, 2
        ...
        soil1(j)%microb(l)%n = soil1(j)%microb(l)%n + rtof * xx * frt_kg *   & ! changed tot(l)%n to microb(l)%n, KDW 10/21/21
                       fertdb(ifrt)%forgn
        soil1(j)%hs(l)%n = soil1(j)%hs(l)%n + (1. - rtof) * xx * &
            frt_kg * fertdb(ifrt)%forgn
        soil1(j)%microb(l)%p = soil1(j)%microb(l)%p + rtof * xx * frt_kg *   & ! changed tot(l)%p to microb(l)%p, KDW 10/21/21
                       fertdb(ifrt)%forgp
