      ...
      real, dimension (:), allocatable :: hminpa      !mg P/L        |active mineral phosphorus concentration in reach at end of hour - KDW
      real, dimension (:), allocatable :: hminps      !mg P/L        |stable mineral phosphorus concentration in reach at end of hour - KDW
      ...
      real :: vol_0               !m^3 ! KDW 04/04/22
      real :: qdbank              ! instead of declaring within channel_control ! KDw 04/04/22
      integer:: sed_ch 
      ...
      type channel
          ...
          real :: minpa = 0.     !               |active mineral phosphorus concentration in reach - KDW
          real :: minps = 0.     !               |stable mineral phosphorus concentration in reach - KDW
          ...
          real :: sedst = 0. ! metric tons   |amount of sediment stored in reach - water column, KDW
          ...
          real :: bactlp = 0.
          !! Added by KDW
          real :: aer_orgp = 10. ! mg/kg or g/Mg
          real :: aer_minpa = 100. ! mg/kg or g/Mg - updated IC 08/10, KDW
          real :: aer_minps = 200. ! mg/kg or g/Mg - updated IC 08/10, KDW
          real :: aer_disp = 0.05  ! mg/L
          real :: anaer_orgp = 10. ! mg/kg or g/Mg
      ...
      type (channel), dimension(:), allocatable :: channel_init ! KDW 03/29

      !! Added by KDW, 11/04/21
      type strbed_init
          real :: aer_orgp = 0. ! mg/kg or g/Mg
          real :: aer_minpa = 0. ! mg/kg or g/Mg 
          real :: aer_minps = 0. ! mg/kg or g/Mg 
          real :: aer_disp = 0.  ! mg/L
          real :: anaer_orgp = 0. ! mg/kg or g/Mg
          real :: anaer_minpa = 0. ! mg/kg or g/Mg
          real :: anaer_minps = 0. ! mg/kg or g/M
          real :: anaer_disp = 0. ! mg/L
      end type strbed_init
      type (strbed_init), dimension(:), allocatable :: streambed_init
      character(len=16), dimension(:), allocatable :: streambed_init_name
      !! End: Added by KDW, 11/04/21
      
      type ch_output
          real :: flo_in = 0.                  ! (m^3/s)     |streamflow into reach during time step ; unit changed from ha-m b/c code changed - KDW
          real :: flo_out = 0.                 ! (m^3/s)     |streamflow out of reach during time step ; unit changed from ha-m b/c code changed - KDW
          real :: evap = 0.                    ! (ha-m)    |daily rate of water loss from reach by evaporation ; unit changed from m^3/s b/c incorrect - KDW
          real :: tloss = 0.                   ! (ha-m)    |rate of water loss from reach by transmission through the streambed ; unit changed from m^3/s b/c incorrect - KDW 
          ...
          real :: minpa_in = 0.                ! (kg P)     |active mineral phosphorus transported with water into reach - KDW
          real :: minpa_out = 0.               ! (kg P)     |active mineral phosphorus transported with water out of reach  - KDW
          real :: minps_in = 0.                ! (kg P)     |stable mineral phosphorus transported with water into reach  - KDW
          real :: minps_out = 0.               ! (kg P)     |stable mineral phosphorus transported with water out of reach  - KDW
          ...
          real :: solp_in = 0.                 ! (kg P)     |soluble phosphorus transported with water into reach
          real :: solp_out = 0.                ! (kg P)     |soluble phosphorus transported with water out of reach
          ...
          real :: phos_dep = 0.                !            | deposition of P in streambed, all forms - KDW 06/04
          real :: phos_ero = 0.                !            | erosion of P from streambed, all forms - KDW 06/04
          real :: phos_diff = 0.               !            | difffusion from the bed to the water column - KDW 06/04
          real :: aer_orgp = 0.               ! mg/kg or g/Mg - KDW  06/04
          real :: aer_minpa = 0.             ! mg/kg or g/Mg - KDW  06/04
          real :: aer_minps = 0.             ! mg/kg or g/Mg - KDW  06/04
          real :: aer_disp = 0.              ! mg/L - KDW  06/04
          real :: anaer_orgp = 0.             ! mg/kg or g/Mg - KDW  06/04
          real :: anaer_minpa = 0.           ! mg/kg or g/Mg - KDW  06/04
          real :: anaer_minps = 0.           ! mg/kg or g/Mg - KDW  06/04
          real :: anaer_disp = 0.             ! mg/L - KDW  06/04
      ...
      type ch_header
          ...
          character(len=14) :: flo_in =       "     flo_in    "        ! (ha-m) !changed from 16 to 14, KDW, 06/07 (and from 15 to 14 for below)
          character(len=14) :: flo_out =      "     flo_out  "         ! (ha-m)
          character(len=14) :: evap =         "     evap     "       ! (ha-m)
          character(len=14) :: tloss =        "      tloss   "         ! (ha-m)
          character(len=14) :: sed_in =       "      sed_in  "        ! (tons)
          character(len=14) :: sed_out=       "      sed_out  "        ! (tons)
          character(len=14) :: sed_conc =     "     sed_conc  "        ! (mg/L)
          character(len=14) :: orgn_in =      "      orgn_in "          ! (kg N)
          character(len=14) :: orgn_out =     "     orgn_out "        ! (kg N)
          character(len=14) :: orgp_in =      "      orgp_in "     ! (kg P)
          character(len=14) :: orgp_out =     "      orgp_out"        ! (kg P)
          character(len=14) :: minpa_in =      "     minpa_in "     ! (kg P) - KDW
          character(len=14) :: minpa_out =     "     minpa_out"        ! (kg P)  - KDW
          character(len=14) :: minps_in =      "     minps_in "     ! (kg P)  - KDW
          character(len=14) :: minps_out =     "     minps_out"        ! (kg P)  - KDW
          character(len=14) :: no3_in =       "      no3_in  "        ! (kg N)
          character(len=14) :: no3_out =      "     no3_out  "        ! (kg N)
          character(len=14) :: nh4_in =       "       nh4_in "        ! (kg)
          character(len=14) :: nh4_out=       "      nh4_out "        ! (kg)
          character(len=14) :: no2_in =       "       no2_in "        ! (kg)
          character(len=14) :: no2_out =      "      no2_out "        ! (kg)
          character(len=14) :: solp_in =      "     solp_in  "        ! (kg P)
          character(len=14) :: solp_out =     "    solp_out  "        ! (kg P)
          character(len=14) :: chla_in =      "      chla_in "        ! (kg)
          character(len=14) :: chla_out =     "     chla_out "        ! (kg)
          character(len=14) :: cbod_in =      "      cbod_in "        ! (kg)
          character(len=14) :: cbod_out =     "     cbod_out "        ! (kg)
          character(len=14) :: dis_in =       "       dis_in "        ! (kg)
          character(len=14) :: dis_out =      "      dis_out "        ! (kg)
          character(len=14) :: phos_dep=       "     phos_dep "        ! (kg)- KDW  06/04
          character(len=14) :: phos_ero =       "     phos_ero "        ! (kg)- KDW  06/04
          character(len=14) :: phos_diff =      "    phos_diff "        ! (kg)- KDW  06/04
          character(len=14) :: aer_orgp =      "     aer_orgp "        ! (mg/kg)- KDW  06/04
          character(len=14) :: aer_minpa =     "    aer_minpa "        ! (mg/kg)- KDW  06/04
          character(len=14) :: aer_minps =      "     aer_minps"        ! (mg/kg)- KDW  06/04
          character(len=14) :: aer_disp =     "      aer_disp"        ! (mg/L)- KDW  06/04
          character(len=14) :: anaer_orgp =      "    anaer_orgp"        ! (mg/kg)- KDW  06/04
          character(len=14) :: anaer_minpa =     "   anaer_minpa"        ! (mg/kg)- KDW  06/04
          character(len=14) :: anaer_minps =       "   anaer_minps"        ! (mg/kg)- KDW  06/04
          character(len=14) :: anaer_disp =      "    anaer_disp"        ! (mg/L)- KDW  06/04
          ...
          character(len=14) :: sand_in =      "       sand_in"        ! sand in 
          character(len=14) :: sand_out =     "      sand_out"        ! sand out
          character(len=14) :: silt_in =      "       silt_in"        ! silt_in
          character(len=14) :: silt_out =     "      silt_out"        ! silt_out
          character(len=14) :: clay_in =      "       clay_in"        ! clay_in
          character(len=14) :: clay_out =     "      clay_out"        ! clay_out
          character(len=14) :: smag_in =      "       smag_in"        ! sm ag in  
          character(len=14) :: smag_out =     "      smag_out"        ! sm ag out
          character(len=14) :: lag_in =       "        lag_in"        ! lg ag in
          character(len=14) :: lag_out =      "       lag_out"        ! lg ag out
          character(len=14) :: grvl_in =      "       grvl_in"        ! gravel in
          character(len=14) :: grvl_out =     "      grvl_out"        ! gravel out
          character(len=14) :: bnk_ero =      "       bnk_ero"        ! bank erosion
          character(len=14) :: ch_deg =       "        ch_deg"        ! channel degradation
          character(len=14) :: ch_dep =       "        ch_dep"        ! channel deposition
          character(len=14) :: fp_dep =       "        fp_dep"        ! flood deposition         
          character(len=14) :: tot_ssed =     "      tot_ssed"        ! total suspended sediments       
      end type ch_header
      ...
      type ch_header_units
          ...
          character(len=14) :: flo_in      =   "     m^3/s"            ! (m^3/s) !changed from 16 to 14, KDW, 06/07 (and from 15 to 14 for below)
          character(len=14) :: flo_out     =   "     m^3/s"             ! (m^3/s)
          character(len=14) :: evap        =   "       ha-m"            ! (ha-m)
          character(len=14) :: tloss       =   "     ha-m"              ! (ha-m)
          character(len=14) :: sed_in      =   "       tons"            ! (tons)
          character(len=14) :: sed_out     =   "       tons"            ! (tons)
          character(len=14) :: sed_conc    =   "       mg/L"            ! (mg/L)
          character(len=14) :: orgn_in     =   "       kgN"             ! (kg N)
          character(len=14) :: orgn_out    =   "        kgN"            ! (kg N)
          character(len=14) :: orgp_in     =   "         kgP"           ! (kg P)
          character(len=14) :: orgp_out    =   "          kgP"          ! (kg P)
          character(len=14) :: minpa_in    =   "         kgP"           ! (kg P) - KDW
          character(len=14) :: minpa_out   =   "          kgP"          ! (kg P) - KDW
          character(len=14) :: minps_in    =   "         kgP"           ! (kg P) - KDW
          character(len=14) :: minps_out   =   "          kgP"          ! (kg P) - KDW
          character(len=14) :: no3_in      =   "         kgN"           ! (kg N)
          character(len=14) :: no3_out     =   "         kgN"           ! (kg N)
          character(len=14) :: nh4_in      =   "           kg"          ! (kg)
          character(len=14) :: nh4_out     =   "           kg"          ! (kg)
          character(len=14) :: no2_in      =   "           kg"          ! (kg)
          character(len=14) :: no2_out     =   "           kg"          ! (kg)
          character(len=14) :: solp_in     =   "         kgP"           ! (kg P)
          character(len=14) :: solp_out    =   "         kgP"           ! (kg P)
          character(len=14) :: chla_in     =   "           kg"          ! (kg)
          character(len=14) :: chla_out    =   "           kg"          ! (kg)
          character(len=14) :: cbod_in     =   "           kg"           ! (kg)
          character(len=14) :: cbod_out    =   "           kg"           ! (kg)
          character(len=14) :: dis_in      =   "           kg"           ! (kg)
          character(len=14) :: dis_out     =   "           kg"           ! (kg)
          character(len=14) :: phos_dep=       "          kg  "        ! (kg)- KDW  06/04
          character(len=14) :: phos_ero =       "          kg  "        ! (kg)- KDW  06/04
          character(len=14) :: phos_diff =      "         kg   "        ! (kg)- KDW  06/04
          character(len=14) :: aer_orgp =      "         mg/kg"        ! (mg/kg)- KDW  06/04
          character(len=14) :: aer_minpa =     "         mg/kg"        ! (mg/kg)- KDW  06/04
          character(len=14) :: aer_minps =      "         mg/kg"        ! (mg/kg)- KDW  06/04
          character(len=14) :: aer_disp =     "          mg/L"        ! (mg/L)- KDW  06/04
          character(len=14) :: anaer_orgp =      "        mg/kg "        ! (mg/kg)- KDW  06/04
          character(len=14) :: anaer_minpa =     "         mg/kg"        ! (mg/kg)- KDW  06/04
          character(len=14) :: anaer_minps =       "       mg/kg  "        ! (mg/kg)- KDW  06/04
          character(len=14) :: anaer_disp =      "          mg/L"        ! (mg/L)- KDW  06/04
          ...
          character(len=14) :: sand_in     =   "          ----"        ! sand in 
          character(len=14) :: sand_out    =   "          ----"        ! sand out
          character(len=14) :: silt_in     =   "          ----"        ! silt_in
          character(len=14) :: silt_out    =   "          ----"        ! silt_out
          character(len=14) :: clay_in     =   "          ----"        ! clay_in
          character(len=14) :: clay_out    =   "          ----"        ! clay_out
          character(len=14) :: smag_in     =   "          ----"        ! sm ag in  
          character(len=14) :: smag_out    =   "          ----"        ! sm ag out
          character(len=14) :: lag_in      =   "          ----"        ! lg ag in
          character(len=14) :: lag_out     =   "          ----"        ! lg ag out
          character(len=14) :: grvl_in     =   "          ----"        ! gravel in
          character(len=14) :: grvl_out    =   "          ----"        ! gravel out
          character(len=14) :: bnk_ero     =   "          ----"        ! bank erosion
          character(len=14) :: ch_deg      =   "          ----"        ! channel degradation
          character(len=14) :: ch_dep      =   "          ----"        ! channel deposition
          character(len=14) :: fp_dep      =   "          ----"        ! flood deposition         
          character(len=14) :: tot_ssed    =   "          ----"        ! total suspended sediments       
      ...
      type (ch_output) :: cho3
       ...
       cho3%minpa_in = cho1%minpa_in + cho2%minpa_in ! - KDW
       cho3%minpa_out = cho1%minpa_out + cho2%minpa_out ! - KDW
       cho3%minps_in = cho1%minps_in + cho2%minps_in ! - KDW
       cho3%minps_out = cho1%minps_out + cho2%minps_out ! - KDW
       ...
       cho3%phos_dep = cho1%phos_dep + cho2%phos_dep ! - KDW
       cho3%phos_ero = cho1%phos_ero + cho2%phos_ero ! - KDW
       cho3%phos_diff = cho1%phos_diff + cho2%phos_diff ! - KDW
       cho3%aer_orgp = cho1%aer_orgp + cho2%aer_orgp ! - KDW
       cho3%aer_minpa = cho1%aer_minpa + cho2%aer_minpa ! - KDW
       cho3%aer_minps = cho1%aer_minps + cho2%aer_minps ! - KDW
       cho3%aer_disp = cho1%aer_disp + cho2%aer_disp ! - KDW
       cho3%anaer_orgp = cho1%anaer_orgp + cho2%anaer_orgp ! - KDW
       cho3%anaer_minpa = cho1%anaer_minpa + cho2%anaer_minpa ! - KDW
       cho3%anaer_minps = cho1%anaer_minps + cho2%anaer_minps ! - KDW
       cho3%anaer_disp = cho1%anaer_disp + cho2%anaer_disp ! - KDW
      ...
      function ch_div (ch1,const) result (ch2)
        ...
        ch2%minpa_in = ch1%minpa_in / const    ! - KDW
        ch2%minpa_out = ch1%minpa_out / const    ! - KDW
        ch2%minps_in = ch1%minps_in / const    ! - KDW
        ch2%minps_out = ch1%minps_out / const    ! - KDW         
        ...
        ch2%phos_dep = ch1%phos_dep / const  ! - KDW
        ch2%phos_ero = ch1%phos_ero / const  ! - KDW
        ch2%phos_diff = ch1%phos_diff / const  ! - KDW
        ch2%aer_orgp = ch1%aer_orgp / const  ! - KDW
        ch2%aer_minpa = ch1%aer_minpa / const  ! - KDW
        ch2%aer_minps = ch1%aer_minps / const  ! - KDW
        ch2%aer_disp = ch1%aer_disp / const  ! - KDW
        ch2%anaer_orgp = ch1%anaer_orgp / const  ! - KDW
        ch2%anaer_minpa = ch1%anaer_minpa / const  ! - KDW
        ch2%anaer_minps = ch1%anaer_minps / const  ! - KDW
        ch2%anaer_disp = ch1%anaer_disp / const  ! - KDW            
      ...
      function ch_mult (const, chn1) result (chn2)
        ...
        chn2%minpa_in = const * chn1%minpa_in    ! - KDW
        chn2%minpa_out = const * chn1%minpa_out   ! - KDW
        chn2%minps_in = const * chn1%minps_in   ! - KDW
        chn2%minps_out = const * chn1%minps_out   ! - KDW 
        ...
        chn2%phos_dep = const * chn1%phos_dep   ! - KDW
        chn2%phos_ero = const * chn1%phos_ero ! - KDW
        chn2%phos_diff = const * chn1%phos_diff  ! - KDW
        chn2%aer_orgp = const * chn1%aer_orgp   ! - KDW
        chn2%aer_minpa = const * chn1%aer_minpa   ! - KDW
        chn2%aer_minps = const * chn1%aer_minps   ! - KDW
        chn2%aer_disp = const * chn1%aer_disp   ! - KDW
        chn2%anaer_orgp = const * chn1%anaer_orgp  ! - KDW
        chn2%anaer_minpa = const * chn1%anaer_minpa  ! - KDW
        chn2%anaer_minps = const * chn1%anaer_minps   ! - KDW
        chn2%anaer_disp = const * chn1%anaer_disp   ! - KDW   
