...
!! concentrations
         ...
         orgpin = 1000. * ob(icmd)%ts(1,ii)%orgp / wtrin ! - KDW
         ...
         if (orgpin < 1.e-6) orgpin = 0.0 ! - KDW
         ...
         minpacon = (minpain * wtrin + ch(jrch)%minpa * hrchwtr(ii))  / wtrtot ! - KDW
         minpscon = (minpsin * wtrin + ch(jrch)%minps * hrchwtr(ii))  / wtrtot ! - KDW
