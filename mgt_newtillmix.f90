...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
    ...
    if (dtil < 10.0) dtil = 11.0
	 do l = 1, soil(jj)%nly
          ...
          smix(8) = smix(8) + soil1(jj)%microb(l)%n * WW1 ! KDW 10/21/21, changed tot(l)% to microb(l)%
          smix(9) = smix(9) + soil1(jj)%microb(l)%p * WW1 ! KDW 10/21/21, changed tot(l)% to microb(l)%
		...
		!! concentration based mixing
          ...
          do l = 1, soil(jj)%nly
            ...
            soil1(jj)%microb(l)%n = soil1(jj)%microb(l)%n * WW3 + smix(8) * WW4 ! KDW 10/21/21, changed tot(l)% to microb(l)%
            soil1(jj)%microb(l)%p = soil1(jj)%microb(l)%p * WW3 + smix(9)*WW4 ! KDW 10/21/21, changed tot(l)% to microb(l)%
