      ...
      type plant_db
        ...
        real :: bmx_peren = 100.        !metric tons/ha    |max biomass for forest
      ...
      type plant_init_db
        ...
        real :: pop = 0.
        real :: fr_yrmat = 1.              !years      |fraction of current year of growth to years to maturity !changed from 20 to 1, KDW 12/14/21
