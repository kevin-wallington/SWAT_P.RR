      ...
      do ipl = 1, pcom(j)%npl
        ...
        if (manure_kg > 0.) then 
          ...
          soil1(j)%microb(l)%n = soil1(j)%microb(l)%n + manure_kg *      &
                                                   fertdb(it)%forgn ! KDW 10/21/21, changed tot(l)% to microb(l)%
          soil1(j)%mn(l)%nh4 = soil1(j)%mn(l)%nh4 + manure_kg *      &
                       fertdb(it)%fnh3n * fertdb(it)%fminn
          soil1(j)%mp(l)%lab = soil1(j)%mp(l)%lab + manure_kg *      &
                       fertdb(it)%fminp
          soil1(j)%microb(l)%p = soil1(j)%microb(l)%p + manure_kg *      & ! KDW 10/21/21, changed tot(l)% to microb(l)%
                       fertdb(it)%forgp
          end if
