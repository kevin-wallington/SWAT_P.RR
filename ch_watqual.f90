...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      use climate_module
      use basin_module !! KDW

      implicit none

      !integer :: icmd        !units         |description - comment out? - KDW
      !integer :: jrch        !none          |reach number - comment out? - KDW
      !integer :: iwst        !none          |counter - comment out? - KDW
      ...
      real :: minpacon        !mg P/L        |initial active ineral P concentration in reach - KDW
      ...
      dcoef= 3.
       ...
       !! initialize water stored in reach at beginning of day - KDW
       rchwtr = 0
...
!! concentrations
         ...
         orgpin = 1000. * ob(icmd)%hin%orgp  / wtrin ! - KDW
         minpain = 1000. * ob(icmd)%hin%minpa  / wtrin ! - KDW
         minpsin = 1000. * ob(icmd)%hin%minps  / wtrin ! - KDW
         ...
         minpacon =(minpain * wtrin + ch(jrch)%minpa * rchwtr) / wtrtot ! - KDW
         minpscon =(minpsin * wtrin + ch(jrch)%minps * rchwtr) / wtrtot ! - KDW
...
!! oxygen calculations
	   ...
	   if (ch(jrch)%rch_cbod > dcoef * cbodcon) ch(jrch)%rch_cbod = dcoef * cbodcon
         ...
         !!if (vv > 0.) then !! commented out to match SWAT 2012 - KDW
           doxrch = soxy
         !!else !! commented out to match SWAT 2012 - KDW
         !!  coef = exp(-0.03 * vv) !! commented out to match SWAT 2012 - KDW
         !!  doxrch = coef * soxy !! commented out to match SWAT 2012 - KDW
         !!end if !! commented out to match SWAT 2012 - KDW
         ...
         !!                                              dcoef * o2con !! commented out to match SWAT 2012 - KDW
