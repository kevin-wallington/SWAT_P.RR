...
!!    sediment routing
      ...
      if (time%step == 0) then
            ob(icmd)%hd(1)%orgn = ch(jrch)%organicn * rtwtr_d / 1000. + ch(jrch)%orgn ! changed rtwtr to rtwtr_d here and next 13 lines, KDW 04/04/12
            !ob(icmd)%hd(1)%sedp = ch(jrch)%organicp * rtwtr_d / 1000. + ch(jrch)%orgp
	...
	! From this point, check each variables if it is simulated at subdaily interval before using the output - Jaehak 9/11/09
          ...
          ob(icmd)%ts(1,ii)%orgp = horgp(ii) *  hrtwtr(ii) / 1000. ! - KDW
          ob(icmd)%ts(1,ii)%minpa = hminpa(ii) *  hrtwtr(ii) / 1000. ! - KDW
          ob(icmd)%ts(1,ii)%minps = hminps(ii) *  hrtwtr(ii) / 1000. ! - KDW
          ...
          ob(icmd)%hd(1)%orgp = ob(icmd)%hd(1)%orgp +                   &
                                             ob(icmd)%ts(1,ii)%orgp ! - KDW
          ob(icmd)%hd(1)%minpa = ob(icmd)%hd(1)%minpa +                   &
                                             ob(icmd)%ts(1,ii)%minpa ! - KDW
          ob(icmd)%hd(1)%minps = ob(icmd)%hd(1)%minps +                   &
                                             ob(icmd)%ts(1,ii)%minps ! - KDW
